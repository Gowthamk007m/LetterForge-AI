...
import { FileText, ChevronRight, ChevronLeft,Wand2,Eye } from "lucide-react";
...
/** handle input change */
  ...
  const handleGenerate = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://gowtham007.pythonanywhere.com/api/v1/generate-cover-', {
        method: 'POST',
